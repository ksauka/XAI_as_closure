...
| HIC Stage 1 priority steering before recommendation | Excluded | HIC is not a current factor; steering could alter a pre-registered verdict and confound P×A×F. |
...
| High-explainability citation chips | Ported as compact Policy/Role/CV chips | Current `P` factor adds only source surfacing; card wording remains unchanged. |
