...
from .qualtrics_clean import _is_metadata_row, load_and_clean
...
def merge_sessions_with_qualtrics(
    ...
    post_rows, post_stats = load_and_clean(
        post_csv, pid_col=post_key, source_label="post"
    )
